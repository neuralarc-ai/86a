          ...
          <div className="flex-1 overflow-hidden">
            ...
            <TabsContent value="tasks" className="h-full m-0 p-4">
              <div className="h-full overflow-auto space-y-4">
                                {/* Live Crawling Simulation */}
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center space-x-2">
                                    <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                                    <span className="text-sm font-medium text-gray-700">Live Crawling</span>
                                  </div>
                                  <Badge variant="outline" className="text-xs">
                                ...
                                <div className="space-y-2">
                                  <div className="flex items-center space-x-2">
                                    ...
                                    <div className="h-3 bg-blue-200 rounded animate-pulse" style={{width: `${60 + (Date.now() / 100) % 40}%`}}></div>
                                  </div>
                                  <div className="flex items-center space-x-2">
                                    <div className="w-2 h-2 bg-green-500 rounded-full animate-bounce" style={{animationDelay: '0.2s'}}></div>
                                    <div className="h-3 bg-green-200 rounded animate-pulse" style={{width: `${40 + (Date.now() / 150) % 50}%`, animationDelay: '0.2s'}}></div>
                                  </div>
                                  <div className="flex items-center space-x-2">
                                    <div className="w-2 h-2 bg-purple-500 rounded-full animate-bounce" style={{animationDelay: '0.4s'}}></div>
                                    <div className="h-3 bg-purple-200 rounded animate-pulse" style={{width: `${70 + (Date.now() / 200) % 30}%`, animationDelay: '0.4s'}}></div>
                                  </div>
                                </div>
                                
                                {/* Data Extraction Visualization */}
                                <div className="mt-4 grid grid-cols-3 gap-2">
                                  <div className="h-12 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg flex items-center justify-center">
                                    <div className="text-xs text-blue-700 font-medium">Text</div>
                                  </div>
                                  <div className="h-12 bg-gradient-to-br from-green-100 to-green-200 rounded-lg flex items-center justify-center">
                                    <div className="text-xs text-green-700 font-medium">Links</div>
                                  </div>
                                ...
                                <div className="flex items-center justify-between text-xs text-gray-500">
                                  <span>Extracting: {['Headers', 'Content', 'Links', 'Images', 'Metadata'][Math.floor(Date.now() / 1500) % 5]}</span>
                                  <span>{Math.floor(Math.random() * 50 + 50)} items found</span>
                                </div>
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="mt-4 grid grid-cols-3 gap-2">
                                  <div className="h-16 bg-blue-100 rounded flex items-center justify-center">
                                    <span className="text-xs text-blue-700 font-medium">245 Text</span>
                                  </div>
                                  <div className="h-16 bg-green-100 rounded flex items-center justify-center">
                                    <span className="text-xs text-green-700 font-medium">67 Links</span>
                                  </div>
                                  <div className="h-16 bg-purple-100 rounded flex items-center justify-center">
                                    <span className="text-xs text-purple-700 font-medium">23 Images</span>
                                  </div>
                                </div>
                                <div className="absolute top-2 right-2">
                                  <Badge variant="secondary" className="text-xs">
                  ...
                  <Card className="mt-4 border-t-2 border-blue-200 dark:border-blue-800">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-2">
                          <Monitor className="h-4 w-4 text-blue-600" />
                          <span className="text-sm font-medium">Screen Progression</span>
                        </div>
                        <Badge variant="outline" className="text-xs">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center space-x-2 overflow-x-auto pb-2">
                          {[1, 2, 3, 4, 5].map((step, index) => {
                            const isActive = currentSnapshot.toolCall.toolResult?.content === 'STREAMING' && 
                                           step === (Math.floor(Date.now() / 2000) % 5 + 1);
                            const isCompleted = currentSnapshot.toolCall.toolResult?.content !== 'STREAMING' || 
                                              step < (Math.floor(Date.now() / 2000) % 5 + 1);
                            
                            return (
                              <div key={step} className="flex flex-col items-center space-y-1 min-w-[60px]">
                                <div className={cn(
                                ...
                                <span className="text-xs text-center text-muted-foreground">
                                  {['Navigate', 'Extract', 'Process', 'Analyze', 'Complete'][index]}
                                </span>
                              </div>
                            );
                          })}
                        ...
                        <div className="flex items-center justify-between p-3 bg-muted/20 rounded-lg">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm">
                              {currentSnapshot.toolCall.toolResult?.content === 'STREAMING' 
                                ? ['Navigating to page...', 'Extracting content...', 'Processing data...', 'Analyzing results...', 'Finalizing...'][Math.floor(Date.now() / 2000) % 5]
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between text-xs text-muted-foreground">
                            ...
                            <span>
                              {currentSnapshot.toolCall.toolResult?.content === 'STREAMING' 
                                ? `${Math.floor(((Math.floor(Date.now() / 2000) % 5 + 1) / 5) * 100)}%`
                                : '100%'
                              }
                            </span>
                          </div>
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div 
                              ...
                              style={{
                                width: currentSnapshot.toolCall.toolResult?.content === 'STREAMING' 
                                  ? `${((Math.floor(Date.now() / 2000) % 5 + 1) / 5) * 100}%`
                                  : '100%'
                              }}
                            ></div>
                          </div>
