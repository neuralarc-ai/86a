...
// Define getAgentAvatar above ThreadContent
...
export const ThreadContent: React.FC<ThreadContentProps> = ({
  ...
  return (
    <>
      {/* Custom keyframes for logo animation */}
      <style jsx global>{`
        @keyframes spin-fast-slow-fast {
        ...
        .spin-fast-slow-fast {
          animation: spin-fast-slow-fast 2.5s cubic-bezier(0.4,0,0.2,1) infinite;
        }
      `}</style>
                        ...
                        >
                          ...
                          >
                            <div className="space-y-3 min-w-0 flex-1">
                              {cleanContent && (
                                <Markdown className="text-sm prose prose-sm chat-markdown max-w-none [&>:first-child]:mt-0 prose-headings:mt-3 break-words overflow-wrap-anywhere text-white">
                                  {cleanContent}
                                </Markdown>
                              )}
                                          ...
                                          {detectedTag &&
                                            detectedTag !==
                                              ...
                                              <div className="mt-2 mb-1">
                                                <button className="animate-shimmer inline-flex items-center gap-1.5 py-1 px-1 pr-1.5 text-xs font-medium text-primary bg-muted hover:bg-muted/80 rounded-md transition-colors cursor-pointer border border-primary/20">
                                                  <div className="border-2 bg-gradient-to-br from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-800 flex items-center justify-center p-0.5 rounded-sm border-neutral-400/20 dark:border-neutral-600">
