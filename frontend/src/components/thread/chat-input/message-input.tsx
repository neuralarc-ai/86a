        ...
        <div className="flex items-center justify-between mt-0 mb-1 px-2 flex-shrink-0">
          <div className='flex items-center gap-2 w-full'>
            ...
            <Button
              ...
              size="icon"
              className={cn(
                'w-10 h-10 rounded-full flex items-center justify-center bg-gradient-to-br from-[#FF522A] to-[#5E5EDE]',
          ...
          {subscriptionStatus === 'no_subscription' && !isLocalMode() &&
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>The free tier is severely limited by the amount of usage. Upgrade to experience the full power of Manus AI.</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          }
