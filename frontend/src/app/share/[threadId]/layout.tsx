...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Manus AI',
    description: 'Replay this Agent conversation on Manus AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Manus AI';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Manus AI';
